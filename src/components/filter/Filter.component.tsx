      ...
      <div className={styles.PanelBody}>
        ...
        <ChipSet choice>
          ...
          <Chip
            ...
            onInteraction={() =>
              toggleSelected("likedRecipes", selected.likedRecipes)
            }
          >
            Liked Recipes
          </Chip>
        ...
        <ChipSet choice>
          <Chip
            ...
            onInteraction={() => toggleSelected("russian", selected.russian)}
          >
            Russian
          </Chip>
          <Chip
            ...
            onInteraction={() => toggleSelected("french", selected.french)}
          >
            French
          </Chip>
          <Chip
            ...
            onInteraction={() => toggleSelected("italian", selected.italian)}
          >
            Italian
          </Chip>
        </ChipSet>
